...
export declare namespace Footlink {
...
export interface FootlinkMatchInterface extends utils.Interface {
  contractName: "FootlinkMatch";
  functions: {
    ...
    "mint((string,string,string,string,string,string[],uint256,uint64,uint64,uint16))": FunctionFragment;
...
export interface FootlinkMatch extends BaseContract {
  contractName: "FootlinkMatch";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FootlinkMatchInterface;
  ...
  functions: {
    ...
    getLineup(
      _owner: string,
      overrides?: CallOverrides
    ): Promise<[Footlink.LineUpStructOutput]>;
    ...
    getPlayer(
      _id: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[Footlink.PlayerStructOutput]>;
